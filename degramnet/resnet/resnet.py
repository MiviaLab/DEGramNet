...
from ._common_blocks import ChannelECA

from keras import backend as K
from keras.layers import Dense, BatchNormalization, Activation, Conv2D, ZeroPadding2D, Add, Input, MaxPooling2D, GlobalAveragePooling2D
...
MODELS_PARAMS = {
    'eca_resnet152': ModelParams('eca_resnet152', (3, 8, 36, 3), residual_bottleneck_block, ChannelECA),
}


def ECAResNet152(input_shape=None, input_tensor=None, weights=None, classes=1000, include_top=True, **kwargs):
    return ResNet(
        MODELS_PARAMS['eca_resnet152'],
